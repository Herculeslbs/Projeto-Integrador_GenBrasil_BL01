...
public class Caminho01 {
	...
	public static void contabilizar(int escolhido) 
	{
		...
		System.out.println(escolhas.getQuantasEscolhas02());
	}
	...
	public static void situacao01(String nome) 
	{
		...
		do {
			escolha = Integer.parseInt(JOptionPane
					.showInputDialog(nome + " se arruma, sai de casa e dirige até o trabalho. "
							+ "No estacionamento acidentalmente encosta no carro de "
							+ "um funcionário que estava chegando.\n\n"
							+ "1 - Os dois desceram do carro e se acertaram sobre o problema acontecido, " + nome
