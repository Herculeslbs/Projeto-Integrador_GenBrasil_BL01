...
public class Projeto {
		...
		switch(escolhido)
		{
			case 1:
				...
				return nome + " se arruma, sai de casa e dirige até o trabalho. "
						...
						+ "um funcion�rio que estava chegando.";
			case 2:
				Caminho02.situacao01(nome);
				return nome + " Ficou preocupada em se atrasar para o trabalho, "
						+ "ent�o, colocou rapidamente um shorts e uma blusa que "
						+ "encontrou no arm�rio, e levar a roupa para se trocar "
	...
	public static void main(String[] args) {
		...
		String nomeMulher; //sempre que for m1 � pra ser essa vari�vel
		...
		JOptionPane.showMessageDialog(null,
				"O jogo é simples, tudo se baseia em escolhas, e cada escolha feita no jogo gera uma consequ�ncia, seja boa ou ruim!");

		JOptionPane.showMessageDialog(null, "Bom, já que entendeu, vamos come�ar!");

		nomeMulher = JOptionPane.showInputDialog("Digite o nome da Protagonista para iniciar o jogo interativo:");
